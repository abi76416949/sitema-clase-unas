...
@section('content')
    ...
    <form action="{{ route('clientes.update', ['cliente' => $cliente->NRODOCUMENTO]) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
        <div class="row">
        ...
        <div class="row">
            <x-adminlte-input name="DIASCREDITO" label="Diascredito" placeholder="Diascredito" fgroup-class="col-md-6"
                disable-feedback type="text" />
